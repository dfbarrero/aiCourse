...
\begin{frame}{Artificial neurons}{Activation functions: Sigmoid function}
	...
	%	\centering\includegraphics[width=\linewidth]{figs/sigmoid.png}
 	   \column{.40\textwidth}
	%\begin{equation*}
...
%	\end{itemize}
 %	   \column{.50\textwidth}
%	\centering\includegraphics[width=0.9\linewidth]{figs/step.png}\\
%	Step function\\
%	\centering\includegraphics[width=0.9\linewidth]{figs/ramp.png}\\
%	Ramp function
%	\end{columns}
%\end{frame}
