...
algorithm.observer = [inspyred.ec.observers.file_observer, inspyred.ec.observers.stats_observer, inspyred.ec.observers.plot_observer]
...
#allele_plot(ind_file_name)
#generation_plot(ind_file_name)
print(components[0], components[1], (components[2], components[3]), components[4])
print(moonshot(components[0], components[1], (components[2], components[3]), components[4]))
