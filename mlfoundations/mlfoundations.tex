...
\begin{frame}[fragile]{Types of Machine Learning systems}{Supervised learning (I)}
	...
	\begin{itemize}
		\item Usually human beings \alert{label} the output
	\end{itemize}
	...
	\end{center}
	 ...
	 \begin{itemize}
	 	\item \textbf{Classification} if $y$ is a categorical attribute\\
		In this case, the target attributed is named \alert{class}
...
\begin{frame}{Types of Machine Learning systems}{Unsupervised learning: Dimensionality reduction (I)}
	...
	\begin{itemize}
		\item Reduce the data dimensionality (variables)
...
\begin{frame}{Case studies}{Case study 1: Bank propensity model}
	...
	Business problem
	\begin{itemize}
		\item Identify those clientes prone to buy a service
	\end{itemize}
	Data
	\begin{itemize}
...
\subsection{Case study 2: Social media campaign impact}
...
\subsection{Case study 3: Hubble FGS-3 servo failure prediction}
...
\subsection{Case study 4: Fall detection}
\begin{frame}{Case studies}{Case study 4: Fall detection}
    \begin{columns}
 	   \column{.50\textwidth}
	   \small{
		Client
...
\begin{frame}{Main challenges of Machine Learning}{The curse of dimensionality}
	...
	\includegraphics[width=0.8\linewidth]{figs/curseofdimensionality.png}\\
   	\centering \tiny{\href{http://www.visiondummy.com/2014/04/curse-dimensionality-affect-classification/}{(Source)}}
\end{frame}
...
\begin{frame}{Main challenges of Machine Learning}{Other challenges}
    ...
    \centering \tiny{\href{https://github.com/ageron/handson-ml/blob/master/01_the_machine_learning_landscape.ipynb}{(Source)}}
\end{frame}
