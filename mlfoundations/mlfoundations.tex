...
\begin{frame}{Case studies}{Case study 6: NASA JPL BioSleeve}
    \begin{columns}
	   ...
	   \small{
		...
		Business problem
		\begin{itemize}
			\item Recognize hand gestures
            \item \href{https://spectrum.ieee.org/automaton/robotics/robotics-hardware/jpl-biosleeve-enables-precise-robot-control-through-hand-and-arm-gestures}{(More info)}
		\end{itemize}
		Data
		\begin{itemize}
			\item None
 	   ...
 	   \column{.50\textwidth}
            ...
            \normalsize \href{XXX}{(Paper)}
    \end{columns}
\end{frame}

\subsection{UAV terrain classification}
\begin{frame}{Case studies}{Case study 6: UAV terrain classification}
    \begin{columns}
 	   \column{.50\textwidth}
	   \small{
		Client
		...
		Business problem
		\begin{itemize}
			\item Recognize terrain type
            \item Automatic UAV landing
		\end{itemize}
		Data
		\begin{itemize}
